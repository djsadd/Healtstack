...
urlpatterns = [
    ...
    path('i18n/setlang/', set_language, name='set_language'),  # добавь эту строку
]

urlpatterns += i18n_patterns(
    path('', include('ChatApp.urls')),  # Здесь ваши мультиязычные пути
    # можно добавить и другие мультиязычные пути
)
